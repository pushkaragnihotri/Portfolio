			...
			<div className="condiv">
				...
				<i>
					<p>
						...
						Computer Science & Engineering from B. S. Anangpuria Institute of Technology & Management (BSAITM). I'm
						having about 2 years of experience in Web, AI-based Chatbots & API Development (Rest & GraphQL). I'm skilled
						in JavaScript, Python, and their respective Frameworks & Libraries; possess an exclusive understanding of
						OOP concepts and hands-on experience of RDBMS as well as NoSQL databases. Strong Technical and Analytical
						Aptitude with hands on creativity experience.
					</p>
					<br></br>
					<p>
